...
class DownloadSpeedConfig @Inject constructor(
    private val downloadPreferences: DownloadPreferences? = preferences,
) {
    companion object {
        @Volatile
    ...
    private val limits: Limits
        get() {
            val speed = (downloadPreferences ?: preferences)?.downloadSpeed ?: 8
            return when (speed) {
                8 -> Limits(
