# Dispatch for Reviewer 2 — Milestone 2 (Group 3: User Library Managers)
...
Write your handoff report to `.agents/reviewer_m2_2/handoff.md` with an explicit verdict: `APPROVE` or `REQUEST_CHANGES`.
